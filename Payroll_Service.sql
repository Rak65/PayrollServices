-------------  UC1 - Create employee_payroll table ------------
...
-------------  UC3 - CRUD Operation(Insert in table) on employee_payroll table ------------
    ...
    SELECT * FROM employee_payroll WHERE start BETWEEN CAST('2018-10-01' AS DATE) AND DATE(NOW());
    ...
    SELECT * FROM employee_payroll;
    ALTER TABLE employee_payroll modify gender VARCHAR(1) NOT NULL;
